...
export const decorators = [
  (Story) => (
    ...
    >
      <div className="grid min-h-screen grid-cols-1 grid-rows-[auto_minmax(calc(100vh-217px),1fr)_auto] bg-slate-200 dark:bg-slate-700 sm:grid-cols-[1fr_minmax(640px,1024px)_1fr]">
        <div className="col-span-1 col-start-2 row-start-2 bg-slate-200 dark:bg-slate-700 sm:col-start-2">
          <Story />
        </div>
        <div // left column
