  ...
  return (
    <section
      className={clsx(
        ...
        'prose-code:bg-slate-500 prose-code:text-slate-200 dark:prose-code:bg-slate-400 dark:prose-code:text-slate-700',
        'prose-a:text-rose-700 prose-a:no-underline dark:prose-a:text-rose-300',
