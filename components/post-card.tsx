    ...
    >
      <article className="flex flex-col space-y-4 px-10 py-3 rounded bg-slate-100 dark:bg-slate-500 m-[2px] relative z-10">
        <div className="flex flex-col space-y-2">
          <h2 className="text-slate-800 dark:text-slate-100 text-2xl font-bold leading-normal sm:text-3xl md:text-3xl">
            {post.frontMatter.title}
          </h2>
          <p className="text-slate-600 dark:text-slate-200">{post.frontMatter.excerpt}</p>
