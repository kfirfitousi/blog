...
In this article, we'll go over the basics of building a blog with MDX support using Next.js 13, TypeScript and [next-mdx-remote](https://github.com/hashicorp/next-mdx-remote). The code we'll be writing in this article is available on [GitHub](https://github.com/kfirfitousi/mdx-nextjs-13).
