...
- `ρ` is set to 1 - This is the resolution of the **ρ** parameter. The higher the value, the more accurate the lines will be, but the more lines will be detected.
- `θ` is set to π/180 (1 degree) - This is the resolution of the **θ** parameter. The higher the value, the more accurate the lines will be, but the more lines will be detected.
- `threshold` is set to 100 - This is the minimum number of pixels that need to be on a line for it to be detected.
